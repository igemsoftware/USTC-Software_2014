package Kernel.SmartCanvas
{
	...
	public class SmartLinkSpace extends Sprite{
		...
		public function SmartLinkSpace(){
		...
		public function changeChildID(line:CompressedLine,newID:String):void{
			if(compressedCanvas.lineSpace[line.ID]!=null){
				delete compressedCanvas.lineSpace[line.ID];
				compressedCanvas.lineSpace[newID]=line;
			}
		}
