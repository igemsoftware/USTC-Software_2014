package Assembly.Compressor{
	...
	public class SmartCanvas extends Sprite{
		...
		public function compressChild(node:BioBlock):void{
		...
		public function compressAllChild():void{
			while(floatCanvas.numChildren>0){
				compressChild(floatCanvas.getChildAt(0) as BioBlock);
			}
		}
